...
describe("api reducer", () => {
    ...
    test("test api reducer with YOUTUBE_LIBRARY_LOADER action", () => {
    ...
    test("test api reducer for idempotence with YOUTUBE_LIBRARY_LOADER action amd library already loaded", () => {
        const startState = {
            libraryLoaded: true,
        };
